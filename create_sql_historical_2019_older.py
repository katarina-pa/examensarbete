...
# make sure correct tablename is referenced
table_name = "historical_job_listings_2019_older"

# read in the list of desired fields from a file and clean up one line space and ordered columns
# OBS! Must make sure the correct text file is referenced
...
# connect to the database, make sure you have the correct db name
...
c.execute("SELECT name FROM sqlite_master WHERE type='table' AND name='historical_job_listings_2019_older'")
